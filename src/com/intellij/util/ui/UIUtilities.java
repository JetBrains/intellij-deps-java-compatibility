...
public class UIUtilities {
    ...
    // is implemented to call UIUtilities.stringWidth, the
    // SwingUtilities variant does not take a JComponent, as such
    // UIUtilities.stringWidth can be passed a null Component.
     ...
     * @see UIUtilities#drawVLine(java.awt.Graphics, int, int, int)
     * @see UIUtilities#drawHLine(java.awt.Graphics, int, int, int)
     */
